...
const ControlledStereoPhotoFileInput = ({
  name,
  isLoading,
  setIsUpLoading,
  isEmpty,
  ...
  addPreviews,
  ...rest
}: IControlledStereoPhotoFileInputProps) => {
        ...
        <Paper sx={styles.root}>
          ...
          >
            ...
            <Typography sx={{ mt: "12px" }} color="primary">
              {isEmpty ? t`from1to12` : t`loadMore`}
            </Typography>
          </ButtonBase>
        </Paper>
      )}
...
export default memo(ControlledStereoPhotoFileInput);
