  ...
  return (
    <Box sx={styles.wrap}>
      ...
      <Box sx={styles.wrapItem}>
        ...
        <Typography sx={styles.textItem}>{summary.products_count} {t`common:pc`}.</Typography>
      </Box>
      <Divider/>
      <Box sx={styles.wrapItem}>
        <Typography sx={styles.textItem}>{t`products:ordersCount`}</Typography>
        <Typography sx={styles.textItem}>{summary.orders} {t`common:pc`}.</Typography>
      </Box>
      <Divider/>
      <Box sx={styles.wrapItem}>
        <Typography sx={styles.textItem}>{t`products:salesCount`}</Typography>
        <Typography sx={styles.textItem}>{summary.sales} {t`common:pc`}.</Typography>
      </Box>
      <Divider/>
      <Box sx={styles.wrapItem}>
        <Typography sx={styles.textItem}>{t`products:refundsCount`}</Typography>
        <Typography sx={styles.textItem}>{summary.returns} {t`common:pc`}.</Typography>
      </Box>
      <Divider/>
      <Box sx={styles.wrapItem}>
        <Typography sx={styles.textItem}>{t`products:daysSale`}</Typography>
        <Typography sx={styles.textItem}>{summary.days_on_sale} {t`date:d`}.</Typography>
      </Box>
      <Divider/>
    </Box>
  );
